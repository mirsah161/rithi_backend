...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Partners_Logo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactSectionContactSection
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Location: Schema.Attribute.Component<'address.address', false>;
...
export interface ApiFooterLinkFooterLink extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerAddress: Schema.Attribute.Component<'address.address', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    social_links: Schema.Attribute.Component<'footer.social-link', true> &
      Schema.Attribute.Required;
    trustBadges: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiWorkSectionWorkSection extends Struct.CollectionTypeSchema {
